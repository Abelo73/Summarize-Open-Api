  ...
  return (
    <header className="w-full flex flex-col justify-center items-center">
      <nav className="flex justify-between items-center w-full pt-3 mb-10">
        ...
        <button
          className=" hover:bg-slate-800 bg-black w-[120px] h-[40px] text-white rounded-md"
          type="button"
      ...
      <h2 className="desc">
        Simplify your reading with Sumarize, an open-sourse articles summarizer
        that transform lengthy articles into clear and concise summrise.
      </h2>
    </header>
  );
};
